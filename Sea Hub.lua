...
setfpscap(60)
--//macdinh
local Sea = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
...
local SelectFastAttackMode = (SelectFastAttackMode or "Sea Fast")

SelectedFastAttackMode = {"Normal Attack","Fast Attack","Sea Fast"}
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.07
	elseif SelectFastAttackMode == "Sea Fast" then
		FireCooldown = 0.02
	end
end
...
local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
    ...
    spawn(
            function()
            while wait() do
                if FarmMode == "Farm Bone" and _G.AutoFarm and Sea3 then
                    pcall(  
                            function()                        
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Sea.Position).Magnitude > 1500 then
			        BTP(Sea)
				    elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Sea.Position).Magnitude < 1500 then
				    topos(Sea)
					end
				else
				    topos(Sea)
...
spawn(function()
       while wait() do
         if FarmMode == "Farm Katakuri" and _G.AutoFarm and Sea3 then
         pcall(function()                        
...
local Toggle = Tabs.Main:AddToggle("Start Farm", { Title = "Start Farm", Description = "", Default = false })
Toggle:OnChanged(function(Value)
    _G.AutoFarm = Value
...
spawn(function()
    spawn(function()
        while wait(.1) do
            if CacaoBring and _G.BringMonster and Sea3 then
                pcall(function()
                    for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
task.spawn(function() 
		while wait() do
			if VayRong and _G.BringMonster and Sea3 then 
				pcall(function() 
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
task.spawn(function() 
		while wait() do
			if ConCac and _G.BringMonster and Sea3 then 
				pcall(function() 
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
task.spawn(function() 
		while wait() do
			if Ditme and _G.BringMonster and Sea2 then 
				pcall(function() 
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(
        function()
    while wait() do
        if _G.SelectFarm == "Cacao" and StartFarm and Sea3 then
            pcall(  
                    function()
...
spawn(function()
    while wait() do
        if _G.SelectFarm == "Dragon Scale" and StartFarm and Sea3 then
            pcall(function()
...
spawn(function()
    while wait() do
        if _G.SelectFarm == "Leather" and StartFarm and Sea3 then
            pcall(function()
...
spawn(
        ...
        task.spawn(
                    function()
      while wait(.1) do
			if Lon and _G.BringMonster and Sea2 then 
				pcall(function() 
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(
        function()
                while task.wait() do
      if _G.SelectFarm == "Mystic Droplet" and StartFarm and Sea2 then               
                    pcall(      
                         function()
...
spawn(
        function()
                while task.wait() do
      if _G.SelectFarm == "Vampire Fang" and StartFarm and Sea2 then               
                    pcall(      
                         function()
...
Toggle:OnChanged(function(LuoiQuaAeOi)
    ...
    StopTween(_G.Khi_Dot_Len_Dien)
     ...
     spawn(function()
        while wait() do
            if  _G.Khi_Dot_Len_Dien and Sea1 then
                pcall(function()
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.Auto_Nha_Dien and Sea2 then
...
spawn(function()
    spawn(function()
        while wait(.1) do
            if RenGuKu and _G.BringMonster and Sea2 then
                pcall(function()
                    for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
Toggle:OnChanged(function(KiemNhuLon)
    NgayXuaNgayXuaCoNguoiTenLaAnDepTraiDaTaiDepTraNoiTiengTiktokNoiYoutubeCungNoiHayKiemMotNguoiDangCapHonSeaDiNheCacBanHuhuHu = KiemNhuLon
end)      

spawn(function()
    while wait() do
        if NgayXuaNgayXuaCoNguoiTenLaAnDepTraiDaTaiDepTraNoiTiengTiktokNoiYoutubeCungNoiHayKiemMotNguoiDangCapHonSeaDiNheCacBanHuhuHu then
            pcall(function()
                local args = {
...
--//Farm Sea3 BABABABABABAABABABABABABABABABABA
...
spawn(function()
    while wait(.5) do
        pcall(function()
            if _G.Gan_Duoc_Cho_Khi and Sea3 then
...
StopTween(_G.ThangDauMatLon)
    ...
    spawn(function()
        pcall(function()
            while wait() do
                if _G.ThangDauMatLon and Sea3 then
...
StopTween(_G.Long_Ma_Bac_Giang)
    ...
    spawn(function()
        while wait() do
            if  _G.Long_Ma_Bac_Giang and Sea3 then
                pcall(function()
...
local Toggle = Tabs.item:AddToggle("auto Change", { Title = "Auto Dough King + Farm Item", Description = "", Default = false })
Toggle:OnChanged(function(Value)
...
Toggle:OnChanged(function(SeaHubOnTop)
   removedame = SeaHubOnTop
end)
...
spawn(function()
    while wait() do 
        if _G.Quest_Nhu_Cai_Lon and Sea3 then
            pcall(function()
  if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
