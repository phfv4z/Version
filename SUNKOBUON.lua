...
setfpscap(60)
--//macdinh
local SUNKOBUON = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
...
local SelectFastAttackMode = (SelectFastAttackMode or "SUNKOBUON Fast")

SelectedFastAttackMode = {"Normal Attack","Fast Attack","SUNKOBUON Fast"}
...
local function ChangeModeFastAttack(SelectFastAttackMode)
	...
	elseif SelectFastAttackMode == "Fast Attack" then
		FireCooldown = 0.07
	elseif SelectFastAttackMode == "SUNKOBUON Fast" then
		FireCooldown = 0.02
	end
end
...
local QuestTitle = game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text
    ...
    spawn(
            function()
            while wait() do
                if FarmMode == "Farm Bone" and _G.AutoFarm and SUNKOBUON3 then
                    pcall(  
                            function()                        
                    ...
                    if BypassTP then
                    if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - SUNKOBUON.Position).Magnitude > 1500 then
			        BTP(SUNKOBUON)
				    elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - SUNKOBUON.Position).Magnitude < 1500 then
				    topos(SUNKOBUON)
					end
				else
				    topos(SUNKOBUON)
...
spawn(function()
       while wait() do
         if FarmMode == "Farm Katakuri" and _G.AutoFarm and SUNKOBUON3 then
         pcall(function()                        
...
spawn(function()
    spawn(function()
        while wait(.1) do
            if CacaoBring and _G.BringMonster and SUNKOBUON3 then
                pcall(function()
                    for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
task.spawn(function() 
		while wait() do
			if VayRong and _G.BringMonster and SUNKOBUON3 then 
				pcall(function() 
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
task.spawn(function() 
		while wait() do
			if ConCac and _G.BringMonster and SUNKOBUON3 then 
				pcall(function() 
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
task.spawn(function() 
		while wait() do
			if Ditme and _G.BringMonster and SUNKOBUON2 then 
				pcall(function() 
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(
        function()
    while wait() do
        if _G.SelectFarm == "Cacao" and StartFarm and SUNKOBUON3 then
            pcall(  
                    function()
...
spawn(function()
    while wait() do
        if _G.SelectFarm == "Dragon Scale" and StartFarm and SUNKOBUON3 then
            pcall(function()
...
spawn(function()
    while wait() do
        if _G.SelectFarm == "Leather" and StartFarm and SUNKOBUON3 then
            pcall(function()
...
spawn(
        ...
        task.spawn(
                    function()
      while wait(.1) do
			if Lon and _G.BringMonster and SUNKOBUON2 then 
				pcall(function() 
					for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(
        function()
                while task.wait() do
      if _G.SelectFarm == "Mystic Droplet" and StartFarm and SUNKOBUON2 then               
                    pcall(      
                         function()
...
spawn(
        function()
                while task.wait() do
      if _G.SelectFarm == "Vampire Fang" and StartFarm and SUNKOBUON2 then               
                    pcall(      
                         function()
...
Toggle:OnChanged(function(LuoiQuaAeOi)
    ...
    StopTween(_G.Khi_Dot_Len_Dien)
     ...
     spawn(function()
        while wait() do
            if  _G.Khi_Dot_Len_Dien and SUNKOBUON1 then
                pcall(function()
...
spawn(function()
    while wait() do
        pcall(function()
            if _G.Auto_Nha_Dien and SUNKOBUON2 then
...
spawn(function()
    spawn(function()
        while wait(.1) do
            if RenGuKu and _G.BringMonster and SUNKOBUON2 then
                pcall(function()
                    for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
...
spawn(function()
        pcall(function()
            while wait() do
                if _G.Kiem_Lua and SUNKOBUON2 then
...
Toggle:OnChanged(function(Value)
    ...
    spawn(function()
        while wait() do
            if Auto_Ki_Di and SUNKOBUON2 then
                pcall(function()
...
Toggle:OnChanged(function(KiemNhuLon)
    NgayXuaNgayXuaCoNguoiTenLaAnDepTraiDaTaiDepTraNoiTiengTiktokNoiYoutubeCungNoiHayKiemMotNguoiDangCapHonSUNKOBUONDiNheCacBanHuhuHu = KiemNhuLon
end)      

spawn(function()
    while wait() do
        if NgayXuaNgayXuaCoNguoiTenLaAnDepTraiDaTaiDepTraNoiTiengTiktokNoiYoutubeCungNoiHayKiemMotNguoiDangCapHonSUNKOBUONDiNheCacBanHuhuHu then
            pcall(function()
                local args = {
...
spawn(function()
    while wait(.5) do
        pcall(function()
            if _G.Gan_Duoc_Cho_Khi and SUNKOBUON3 then
...
spawn(function()
    while wait(.2) do
        pcall(function()
            if Gan_Haki_Lon and SUNKOBUON3 then              
...
StopTween(_G.ThangDauMatLon)
    ...
    spawn(function()
        pcall(function()
            while wait() do
                if _G.ThangDauMatLon and SUNKOBUON3 then
...
StopTween(_G.Long_Ma_Bac_Giang)
    ...
    spawn(function()
        while wait() do
            if  _G.Long_Ma_Bac_Giang and SUNKOBUON3 then
                pcall(function()
...
Toggle:OnChanged(function(SUNKOBUONHubOnTop)
   removedame = SUNKOBUONHubOnTop
end)
...
Toggle:OnChanged(function(SUNKOBUONHubOnTop)
   removenotify = SUNKOBUONHubOnTop
end)
...
spawn(function()
    while wait() do 
        if _G.Quest_Nhu_Cai_Lon and SUNKOBUON3 then
            pcall(function()
  if game:GetService("Workspace").Enemies:FindFirstChild("Reborn Skeleton") or game:GetService("Workspace").Enemies:FindFirstChild("Living Zombie") or game:GetService("Workspace").Enemies:FindFirstChild("Demonic Soul") or game:GetService("Workspace").Enemies:FindFirstChild("Posessed Mummy") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Reborn Skeleton" or v.Name == "Living Zombie" or v.Name == "Demonic Soul" or v.Name == "Posessed Mummy" then
...
spawn(
    function()
    while task.wait() do
        if _G.Kill_V4 and SUNKOBUON3 then
            pcall(
                function()
...
Toggle:OnChanged(function(SUNKOBUON)
    ConCacC = SUNKOBUON
end)
...
spawn(function()
        while wait() do
            if _G.Raidlaw and SUNKOBUON2 then
                pcall(function()
